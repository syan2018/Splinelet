...
assert.equal(migrated.kind, 'legacy');
...
console.log(
  'PASS API project envelopes reuse legacy migration and canonical asset decoding; reject ambiguous, invalid and raw V4 inputs',
);
