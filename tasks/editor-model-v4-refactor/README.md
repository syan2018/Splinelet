...
建档：2026-09-19。状态：**计划已拆分，实施未开始**。本目录管理分发、依赖、交付和验收；架构事实以[编辑模型方案](../../docs/architecture/editor-model-review-and-refactor-2026-09-19.md)为唯一来源，验收标准以其中第 10 节的 U01–U06、A01–A23 为准。
...
- 合同版本：待 T00 评审登记；拟产出 `contracts-2026-09-19.md`。
- 总整合负责人 / 最终验收负责人：待认领。各任务的当前状态与执行者只在所属工作包的检查点中维护。
