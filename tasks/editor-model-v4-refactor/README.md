...
建档：2026-09-19。状态：**实施中，当前推进合同与验证基线**。本目录管理分发、依赖、交付和验收；架构事实以[编辑模型方案](../../docs/architecture/editor-model-review-and-refactor-2026-09-19.md)为唯一来源，验收标准以其中第 10 节的 U01–U06、A01–A23 为准。
...
- 合同版本：[v1 已冻结](contracts-2026-09-19.md)，独立走查通过，启动 T02；T01 并行继续。
